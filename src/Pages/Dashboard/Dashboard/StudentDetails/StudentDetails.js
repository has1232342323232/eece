    ...
    <div>
      ...
      <div className="avatar flex items-center justify-center">
        <div className="w-2/5 rounded-full">
          <img src="https://i.ibb.co/Cw8bKhN/1168742.png" />
        </div>
      </div>
      ...
      {isAdmin ? (
        <div className="text-center">
          <h1 className="text-xl text-center text-custom-pink">
            Congrats {data?.name} You are An Admin of This Website
          </h1>
          <br />
          ...
          <br />
          <h3 className="text-xl text-emerald-500">
            Mothers's Name: {data?.mothers_name}
          </h3>
          <br />
          {/* open modal code */}
          <button
          ...
          <dialog id="my_modal_3" className="modal">
            <form method="dialog" className="modal-box">
              ...
              <p className="py-4">
                Congrats to you to your profile. Never stop learning and Stick
                to ..
              </p>
            </form>
          </dialog>
        ...
        <div>
          ...
          <div className="hero min-h-screen ">
            <div className="hero-content text-center">
              <div className="max-w-md">
                ...
                <br />
                <h3 className="text-xl ">Session: {data?.session}</h3>
                <br />
                <h3 className="text-xl text-emerald-500">
                  Father's Name: {data?.fathers_name}
                </h3>
                ...
                <dialog id="my_modal_3" className="modal">
                  <form method="dialog" className="modal-box">
                    ...
                    <h3 className="font-bold text-lg">Hey {data?.name}</h3>
                    <p className="py-4">
                      Congrats to you to your profile. Never stop learning and
                      Stick to ..
                    </p>
                  </form>
                </dialog>
          ...
          <h4 className="text-red-700">
            Your Logged In Email Address: {data?.email}
          </h4>
          <br />
          <br />
